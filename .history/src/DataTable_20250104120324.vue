<template>
    <div :class="{ '__datatable-sm': size === 'sm' }">
        ...
        <div class="d-flex justify-content-between align-items-start align-content-start flex-wrap gap-2 my-1">
            ...
            <div class="mb-1 d-flex align-items-center align-content-center justify-content-end gap-2 flex-wrap">
...
import BBPagination from './Components/ui/BBPagination.vue'
